...
title: "셀럽잇 CI/CD 발전기 - (3-1) 백엔드의 docker와 github actions를 통한 배포 자동화"
...
셀럽잇 CI/CD 발전기 - (3-1) 백엔드의 docker와 github actions를 통한 배포 자동화
...
이 방법 외에도, COPY 대신 BIND MOUNT를 활용하여 성능을 좀 더 높여볼 수 있겠다고 생각하지만,
지금은 시간이 너무 없어서 다음으로 미뤄야 할 것 같습니다..!!

이렇게 해서 이번 글에서는 저희 백엔드 팀의 Docker를 통한 CD 환경 구축 과정을 살펴보았고, <br/>
다음 글에서는 프론트엔드 팀의 Docker를 통한 CD 환경 구축 과정을 살펴보겠습니다.
